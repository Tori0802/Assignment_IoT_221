...
const char *ssid = "MANG DAY KTX AG4-1006";  //ENTER YOUR WIFI SETTINGS
const char *password ="kkkkkkkk" ;
const char *host = "192.168.0.105";
const char *host1 = "http://192.168.0.106:81/IoT/database/Getstatus.php";
const char *host2 = "http://192.168.0.106:81/IoT/database/getdata1.php";
